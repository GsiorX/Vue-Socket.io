...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Observer__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Emitter__ = __webpack_require__(20);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    install(Vue, connection, store){
        ...
        let observer = new __WEBPACK_IMPORTED_MODULE_0__Observer__["a" /* default */](connection, store)
            ...
            created(){
                ...
                this.$options.sockets = new Proxy({}, {
                    set: (target, key, value) => {
                        __WEBPACK_IMPORTED_MODULE_1__Emitter__["a" /* default */].addListener(key, value, this)
                        target[key] = value
                        return true;
                    },
                    deleteProperty: (target, key) => {
                        __WEBPACK_IMPORTED_MODULE_1__Emitter__["a" /* default */].removeListener(key, this.$options.sockets[key], this)
                        delete target.key;
                        return true
                    }
                })
                ...
                this.$options.multisockets = new Proxy({}, {
                  deleteProperty: (target, key) => {
                    Object.keys(this.$options.multisockets[key]).forEach(item  => {
                      __WEBPACK_IMPORTED_MODULE_1__Emitter__["a" /* default */].removeListener(item, this.$options.multisockets[key][item], this)
                    })
                    delete target.key;
                    return true
                  }
                ...
                Object.keys(connection).forEach(object => {
                    this.$options.multisockets[object] = new Proxy({}, {
                      ...
                      deleteProperty: (target, key) => {
                        __WEBPACK_IMPORTED_MODULE_1__Emitter__["a" /* default */].removeListener(key, this.$options.multisockets[object][key], this)
                        delete target.key;
                        return true
                      }
                    })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Emitter__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_socket_io_client__ = __webpack_require__(39);
...
/* harmony default export */ __webpack_exports__["a"] = (class{
    ...
    constructor(connection, store) {
      ...
      if(typeof connection == 'string'){
          this.Socket = __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()(connection);
      } else if(typeof connection == 'object') {
        this.Sockets = []
        Object.keys(connection).forEach(key => {
          this.Sockets[key] = __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()(connection[key]);
        });
      } else{
      ...
      ["connect", "error", "disconnect", "reconnect", "reconnect_attempt", "reconnecting", "reconnect_error", "reconnect_failed", "connect_error", "connect_timeout", "connecting", "ping", "pong"]
        .forEach((value) => {
          socket.on(value, (data) => {
            __WEBPACK_IMPORTED_MODULE_0__Emitter__["a" /* default */].emit(value, data);
